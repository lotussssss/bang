...
;/**import from `/resource/js/mobile/huishou/zhimacredit/common.js` **/
$(function(){
    // 用户评价滚动
...
;/**import from `/resource/js/mobile/huishou/zhimacredit/index/index.js` **/
!function(){
    // 确保回收首页才执行
...
;/**import from `/resource/js/mobile/huishou/zhimacredit/shopHs_index/shopHs_index.js` **/
!function(){
    if (window.__PAGE !== 'zhimacredit-shopHs-index') {
        return
    }

    // $(function () {
    //
    //     $ ('.btn-go-to-assess').on ('click', function (e) {
    //         e.preventDefault ()
    //
    //         // var $ShopHSNewPrice = $ ('[name="shop_hs_new_price"]'),
    //         //     shop_hs_new_price = parseFloat ($.trim ($ShopHSNewPrice.val ()))
    //         //
    //         // if (!shop_hs_new_price) {
    //         //     $.errorAnimate ($ShopHSNewPrice)
    //         //     setTimeout (function () {
    //         //         $ShopHSNewPrice.focus ()
    //         //     }, 300)
    //         //     return $.dialog.toast ('请输入正确的新机价格~')
    //         // }
    //
    //         window.location.href = tcb.setUrl2 ('/zhimacredit/models#!/brand/10')
    //
    //       // 去掉了显示价格,特此注释
    //         // window.location.href = tcb.setUrl2 ('/zhimacredit/models#!/brand/10', {
    //         //     shop_hs_new_price : shop_hs_new_price
    //         // })
    //     })
    //
    // })
...
;/**import from `/resource/js/mobile/huishou/zhimacredit/models/_start.js` **/
!function (global) {
...
;/**import from `/resource/js/mobile/huishou/zhimacredit/assess/_start.js` **/
!function (global) {
    // 非评估页面,直接返回不做任何处理
    if (window.__PAGE!=='zhimacredit-assess'){
        return
    }
...
;/**import from `/resource/js/mobile/huishou/zhimacredit/order/_start.js` **/
!function (global) {
    // 非下单页,直接返回不做任何处理
...
;/**import from `/resource/js/mobile/huishou/zhimacredit/order_submit/_start.js` **/
!function (global) {
    // 非下单页,直接返回不做任何处理
...
;/**import from `/resource/js/mobile/huishou/zhimacredit/shopHs_order_submit/_start.js` **/
!function (global) {
    // 非下单页,直接返回不做任何处理
...
;/**import from `/resource/js/mobile/huishou/zhimacredit/shopHs_order_coupon/shopHs_order_coupon.js` **/
;(function (global) {
  // 非下单页,直接返回不做任何处理
...
;/**import from `/resource/js/mobile/huishou/zhimacredit/shopHs_order_OMS_submit/shopHs_order_OMS_submit.js` **/
;(function () {
  // 非 oms 录入页面,直接返回
...
;/**import from `/resource/js/mobile/huishou/zhimacredit/shopHs_order_OMS_success/shopHs_order_OMS_success.js` **/
;(function () {
  // 非 oms 录入页面,直接返回
  if ( window.__PAGE !== 'zhimacredit-shopHs-order-OMS-success') {
    return
  }
})()

;/**import from `/resource/js/mobile/huishou/zhimacredit/shopHs_order_xxg_confirm/shopHs_order_xxg_confirm.js` **/
!function(){
...
;/**import from `/resource/js/mobile/huishou/zhimacredit/order_detail/order_detail.js` **/
!function () {
