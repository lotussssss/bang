...
;/**import from `/resource/js/component/login_form_by_mobile.js` **/
!function () {
    var Bang = window.Bang = window.Bang || {};
...
;/**import from `/resource/js/page/global_v2.js` **/
(function() {
...
;/**import from `/resource/js/page/wlxq.js` **/
/**
...
;/**import from `/resource/js/page/tuisong.js` **/
/**
