;/**import from `/resource/js/lib/jquery/jquery.js` **/
...
;/**import from `/resource/js/lib/jquery/jquery.tmpl.js` **/
/*简单前端模板，改写自QWrap*/
/**
 * 字符串模板
 * @method tmpl
...
;/**import from `/resource/js/lib/jquery/jquery.cookie.js` **/
/*!
...
;/**import from `/resource/js/lib/jquery/jquery.easing.js` **/
/*
...
;/**import from `/resource/js/lib/jquery/tcb.js` **/
/**
 * 同城帮相关的基础库(jquery版)
...
;/**import from `/resource/js/component/jquery/custom_event.js` **/
;
!function (global) {
    var
...
;/**import from `/resource/js/component/jquery/pager.js` **/
(function (global) {
    var
        tcb = global.tcb = global.tcb || {}
    ...
    Pager.prototype = (function () {
        ...
        return {
            init : function (el, totalPages, currentPage) {
                ...
                tcb.addCustomEventHandle (this)

                $ (el).off ('click', 'a')

                $ (el)
                    .html (getHtml (totalPages, currentPage))
                    ...
                    setTimeout (function () {
                        $ (el).html (getHtml (totalPages, pn))
                    }, 50)  //some error while happen if no settimeout

                    inst.fire ('pageChange', { 'pn' : pn - 0 })
                })
            }
        }
    }) ()
...
;/**import from `/resource/js/component/jquery/login_form_by_mobile.js` **/
!function () {
...
;/**import from `/resource/js/component/jquery/ui_common_login_dialog.js` **/
// pc端全业务通用登陆框
!function () {
    function showCommonLoginPanel(options) {
        ...
        var html_fn = $.tmpl($.trim($('#JsUiCommonLoginDialogTpl').html())),
            html_str = html_fn({
...
;/**import from `/resource/js/lib/jquery/common.js` **/
// 试用通用js
(function(){
