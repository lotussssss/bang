wx.ready(function(){
    ...
    // 微信分享的数据
    wxData = {
        "title" : '双11爆品返场，特惠最后3天！',
        "desc" : '爆品返场，领券最高再省120元！苹果/三星/华为/小米/oppo/vivo/魅族/乐视等各大品牌满500减50，满1000减100，满2000减120！',
        "link" :  "http://bang.360.cn/youpin/erhuo",
        "imgUrl" : 'https://p.ssl.qhimg.com/t01235d1613c30b9c11.png',
...
$(function(){
    ...
    $(window).on('load',function (e) {
        e.preventDefault();
        $('.block-nav-brand-inner ul li [data-name=kuanghuan]').trigger('click')
    })
    ...
    //点击狂欢图片入口中的图片
    $('.photo-entrance ul').on('click','a',function (e) {
        e.preventDefault();
    ...
    function countDownTime(product_list){
        ...
        //取出开始时间和结束时间
        $('.js-countdown').each(function (i, item) {
            var  target_time,
                $me = $(this);
