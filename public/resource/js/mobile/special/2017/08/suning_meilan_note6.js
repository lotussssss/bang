...
!function () {
    wx.ready (function () {
        ...
        // 微信分享的数据
        wxData = {
            "title"   : "预约魅蓝note6，抢半价名额！",
            "desc"    : "魅蓝note6预约开启，报名成功即有机会获得半价购买魅蓝note6新机的名额！",
            "link"    : window.location.protocol + '//' + window.location.host + window.location.pathname,
            "imgUrl"  : 'https://p0.ssl.qhmsg.com/t01559c9dbf1737c6dc.jpg',
...
$(function(){
    ...
    var targetTime = Date.parse ('2017/09/02 00:00:00'),
    ...
    function showApplyPanel () {
        var
            st = $.tmpl ($ ('#JsSuningMeilanNote6ApplyPanelTpl').html ()) (),
            theDialog = tcb.showDialog (st, 'suning-meilan-note6-apply-panel'),
