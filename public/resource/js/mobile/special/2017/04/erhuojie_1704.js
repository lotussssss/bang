...
!function () {
    var
        ...
        wxData = {
            "title"   : '【出游季】 带着她去踏青~摇奖100%有礼，手机装备领卷减减减！',
            "desc"    : '踏青季更优惠，特惠机型限时抢购，支持分期付：华为P9 迷人双帘 1599元起，iPhone 6性价比王 1550元起，vivo X7 柔光双摄1350元起...',
            "link"    : window.location.protocol + '//' + window.location.host + window.location.pathname,
            "imgUrl"  : 'https://p1.ssl.qhmsg.com/t014bef0ba622e09112.jpg',
    ...
    $ (function () {
        ...
        (function(){
            ...
            function drawBonusMap(canvas_dom){
                ...
                tcb.imageOnload('https://p0.ssl.qhmsg.com/t0107a1b0b1bc2de006.png', function(img){
        ...
        function showLoginPanel () {
            ...
            var
                html_fn = $.tmpl (tcb.trim ($ ('#JsMErhuojie201704LoginPanel').html ())),
                html_st = html_fn ()
        ...
        function showBingoPanel(bonus_name, desc){
            var
                html_fn = $.tmpl (tcb.trim ($ ('#JsMErhuojie201704BingoPanel').html ())),
                html_st = html_fn ({
        ...
        function showRollEmptyPanel(){
            var
                html_fn = $.tmpl (tcb.trim ($ ('#JsMErhuojie201704RollEmptyPanel').html ())),
                html_st = html_fn ()
