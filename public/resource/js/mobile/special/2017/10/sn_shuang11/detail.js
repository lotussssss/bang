!function () {
    ...
    wxData = {
        ...
        "link"    : window.location.protocol + '//' + window.location.host + '/wechathuodong/shuang11' +'?from_page=sn_fenxiang&op_id='+(window.__OPEN_ID || tcb.queryUrl(window.location.search, 'op_id')),
    ...
    $ (function () {
        ...
        $ ('.trigger-btn-rolling').on ('click', function (e) {
            ...
            if (window.__DRAW_COUNT < 1) {
                if (window.__DREW_COUNT == 3) {
                    ...
                    return window.Bang.ShareIntro.active({
                        img : 'https://p0.ssl.qhmsg.com/t01ccaa590e001f9091.png',
            ...
            var rollingInst = window.Bang.RollingBonus ({
                ...
                rollUrl             : '/wechathuodong/doGetPrizeOfDoubleOne',
                // roll选项
                rollOptions         : {
                    // 转动周期
                    duration : 6000,
        ...
        function getHelperHeadImgs() {
            $.get('/wechathuodong/doGetHelperHeadImgs',function (res) {
                res = JSON.parse(res)
                if(!res.errno){
                    var html_str = ''
        ...
        function showRollingDialog () {
            var html_fn = $.tmpl ($.trim ($ ('#JsSnShuang11RollingDialogTpl').html ())),
                html_st = html_fn ()
        ...
        function showRollingSuccessDialog (params) {
            params = params || {}
            var html_fn = $.tmpl ($.trim ($ ('#JsSnShuang11RollingSuccessDialogTpl').html ())),
                html_st = html_fn ({
        ...
        function showPrizeListDialog () {
            $.get ('/wechathuodong/doGetUserPrizeList', function (res) {
                ...
                var html_fn = $.tmpl ($.trim ($ ('#JsSnShuang11PrizeListDialogTpl').html ())),
                    html_st = html_fn ({
