...
!function () {
    var // 是否分享
        ...
        title ='',
        desc = ''
    if(window.__CUR_STAGE==1){
        title = 'iPhone X免费抽'
        desc = 'iPhoneX免费抽，11.11提前抢！更有丰富礼品等您来拿'
    }else if(window.__CUR_STAGE==2){
        title = '216元礼包免费送！'
        desc = '邀好友 抢礼包，216元礼包等您来拿、数量有限先到先得！'
    }else if(window.__CUR_STAGE==3){
        title = '疯狂限时抢，天天爆款'
        desc = '尖叫优惠，疯狂限时抢购就在同城帮二手优品'
    }
    ...
    $(function () {
        ...
        if ($('.tab-list .tab-item.cur').index()==0){
            setTimeout(function () {
                typeof lotteryInit == 'function' && lotteryInit()
        ...
        !function(){
            ...
            function drawBonusMap(canvas_dom){
                ...
                tcb.imageOnload ('https://p3.ssl.qhmsg.com/t0173ba709381cb80be.png', function (img) {
        ...
        function showLoginPanel () {
            ...
            var
                html_fn = $.tmpl (tcb.trim ($ ('#JsMShuang11LoginPanel').html ())),
                html_st = html_fn ()
        ...
        function showBingoPanel(bonus_name, desc){
            var
                html_fn = $.tmpl (tcb.trim ($ ('#JsMShuang11BingoPanel').html ())),
                html_st = html_fn ({
        ...
        function showRollEmptyPanel(){
            var
                html_fn = $.tmpl (tcb.trim ($ ('#JsMShuang11RollEmptyPanel').html ())),
                html_st = html_fn ()
        ...
        function renderLotteryUserList(){
            ...
            $.get ('/youpin/doGetLotteryTopList', function (res) {
                ...
                flag_renderLotteryUserList_exc = true
            })
        }
