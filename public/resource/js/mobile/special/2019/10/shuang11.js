...
!function () {
    ...
    // 微信分享的数据
    wxData = {
        "title": "双11全场抄底，抽新款iPhone",
        "desc": "双11抄底狂欢，3期免息，抽新款iPhone，一次购尽兴！",
    ...
    $(function () {
        ...
        tcb.bindEvent(document.body, {
            ...
            '.js-trigger-get-hongbao ':function (e) {
                ...
                $.get('/ypDouble11/doReceivePacket?category_id='+category_id, function (res) {
                    if (!res['errno']) {
                        // 提示领取成功
            ...
            '.js-trigger-get-coupon ':function (e) {
                ...
                $.get('/ypDouble11/doReceiveYouhui?category_id='+category_id, function (res) {
                    if (!res['errno']) {
                        // 提示领取成功
                        $.dialog.toast('恭喜您，领取成功！', 2000)
            ...
            '.lottery-golden-eggs .item-egg': function (e) {
                ...
                var $me = $(this)
                $.get('/ypDouble11/doSmashEgg', function (res) {
                    if (!res['errno']) {
                        // 中奖
            ...
            '.js-trigger-show-my-prize':function (e) {
                ...
                $.get('/ypDouble11/doGetSmashEggHistory',function (res) {
                    if (!res['errno']) {
        ...
        window.Bang.renderProductList({
            $tpl : $('#JsM2019Shuang11ProductListTpl'),
        ...
        // 输出商品列表
        window.Bang.renderProductList({
            $tpl : $('#JsM2019Shuang11HotProductListTpl'),
            $target : $('.block-baokuan .ui-sp-product-list-1'),
            request_url : '/ypDouble11/doGetHot',
            request_params : {
                pn : 0,
                page_size: 4
            },
        ...
        window.Bang.renderProductList({
            ...
            request_url : '/ypDouble11/doGetHeadset',
            request_params : {
                pn : 0,
                page_size: 4
            },
        ...
        function showGoldenEggsBingoPanel() {
            var html_str = $.tmpl($.trim($('#JsM2019Shuang11GoldenEggsBingoPanel').html()))({})
            var config = {
                middle    : true,
        ...
        function showGoldenEggsMyPrizePanel(txt) {
            var html_str = $.tmpl($.trim($('#JsM2019Shuang11GoldenEggsMyPrizePanel').html()))({
                txt:txt
            })
            var config = {
                middle    : true,
        ...
        function renderLotteryUserList() {
            $.get('/ypDouble11/doGetSmashGiftList',function (res) {
